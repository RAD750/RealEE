...
public class ModelCaloriferoNord
  extends ModelBase
{
  ...
  ModelRenderer Mandata;
  ModelRenderer Ritorno;
  ModelRenderer Valvola;
  ModelRenderer Detentore;
  ModelRenderer Supporto1;
  ModelRenderer Supporto2;
  
  public ModelCaloriferoNord()
  {
    textureWidth = 32;
    textureHeight = 32;
    
    Aletta1 = new ModelRenderer(this, 0, 0);
    Aletta1.addBox(0.0F, 0.0F, 0.0F, 1, 14, 3);
    Aletta1.setRotationPoint(0.0F, 9.0F, -7.0F);
    Aletta1.setTextureSize(32, 32);
    Aletta1.mirror = true;
    setRotation(Aletta1, 0.0F, 0.0F, 0.0F);
    Aletta2 = new ModelRenderer(this, 0, 0);
    Aletta2.addBox(0.0F, 0.0F, 0.0F, 1, 14, 3);
    Aletta2.setRotationPoint(2.0F, 9.0F, -7.0F);
    Aletta2.setTextureSize(32, 32);
    Aletta2.mirror = true;
    setRotation(Aletta2, 0.0F, 0.0F, 0.0F);
    Aletta3 = new ModelRenderer(this, 0, 0);
    Aletta3.addBox(0.0F, 0.0F, 0.0F, 1, 14, 3);
    Aletta3.setRotationPoint(4.0F, 9.0F, -7.0F);
    Aletta3.setTextureSize(32, 32);
    Aletta3.mirror = true;
    setRotation(Aletta3, 0.0F, 0.0F, 0.0F);
    Aletta4 = new ModelRenderer(this, 0, 0);
    Aletta4.addBox(0.0F, 0.0F, 0.0F, 1, 14, 3);
    Aletta4.setRotationPoint(6.0F, 9.0F, -7.0F);
    Aletta4.setTextureSize(32, 32);
    Aletta4.mirror = true;
    setRotation(Aletta4, 0.0F, 0.0F, 0.0F);
    Aletta5 = new ModelRenderer(this, 0, 0);
    Aletta5.addBox(0.0F, 0.0F, 0.0F, 1, 14, 3);
    Aletta5.setRotationPoint(-2.0F, 9.0F, -7.0F);
    Aletta5.setTextureSize(32, 32);
    Aletta5.mirror = true;
    setRotation(Aletta5, 0.0F, 0.0F, 0.0F);
    Aletta6 = new ModelRenderer(this, 0, 0);
    Aletta6.addBox(0.0F, 0.0F, 0.0F, 1, 14, 3);
    Aletta6.setRotationPoint(-4.0F, 9.0F, -7.0F);
    Aletta6.setTextureSize(32, 32);
    Aletta6.mirror = true;
    setRotation(Aletta6, 0.0F, 0.0F, 0.0F);
    Aletta7 = new ModelRenderer(this, 0, 0);
    Aletta7.addBox(0.0F, 0.0F, 0.0F, 1, 14, 3);
    Aletta7.setRotationPoint(-6.0F, 9.0F, -7.0F);
    Aletta7.setTextureSize(32, 32);
    Aletta7.mirror = true;
    setRotation(Aletta7, 0.0F, 0.0F, 0.0F);
    Mandata = new ModelRenderer(this, 0, 0);
    Mandata.addBox(0.0F, 0.0F, 0.0F, 13, 1, 1);
    Mandata.setRotationPoint(-7.0F, 10.0F, -6.0F);
    Mandata.setTextureSize(32, 32);
    Mandata.mirror = true;
    setRotation(Mandata, 0.0F, 0.0F, 0.0F);
    Ritorno = new ModelRenderer(this, 0, 0);
    Ritorno.addBox(0.0F, 0.0F, 0.0F, 13, 1, 1);
    Ritorno.setRotationPoint(-7.0F, 21.0F, -6.0F);
    Ritorno.setTextureSize(32, 32);
    Ritorno.mirror = true;
    setRotation(Ritorno, 0.0F, 0.0F, 0.0F);
    Valvola = new ModelRenderer(this, 0, 0);
    Valvola.addBox(0.0F, 0.0F, 0.0F, 1, 1, 4);
    Valvola.setRotationPoint(-8.0F, 10.0F, -8.0F);
    Valvola.setTextureSize(32, 32);
    Valvola.mirror = true;
    setRotation(Valvola, 0.0F, 0.0F, 0.0F);
    Detentore = new ModelRenderer(this, 0, 0);
    Detentore.addBox(0.0F, 0.0F, 0.0F, 1, 1, 3);
    Detentore.setRotationPoint(-8.0F, 21.0F, -8.0F);
    ...
    Supporto1.addBox(0.0F, 0.0F, 0.0F, 1, 1, 3);
    Supporto1.setRotationPoint(5.0F, 11.0F, -8.0F);
    ...
    Supporto2.addBox(0.0F, 0.0F, 0.0F, 1, 1, 3);
    Supporto2.setRotationPoint(-5.0F, 11.0F, -8.0F);
