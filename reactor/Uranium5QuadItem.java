...
public class Uranium5QuadItem
  extends Item implements IReactorComponent
{
  public static final String name = "Sligthly Enriched Uranium Quad Cell";
  public int damage = 7450;
  
  public Uranium5QuadItem(int id)
  {
    super(id);
    maxStackSize = 1;
    iconIndex = 15;
    setItemName("Sligthly Enriched Uranium Quad Cell");
